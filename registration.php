  ...
  <a class="navbar-brand" href="index.php">
    ...
    <form class="reg-form" action="vendor/new_user_check.php" method="post">
            <div class="form_text">Регистрация</div>
              ...
              <?php echo '<div class="error">'.get_error_msg_data('password',$errors[3]).'</div>' ?>
